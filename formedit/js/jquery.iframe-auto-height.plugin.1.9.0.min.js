...
example
    <script type="text/javascript">
     ...
     jQuery('iframe').iframeAutoHeight({debug: true, diagnostics: false});
      // jQuery('#test-case').iframeAutoHeight({debug: true, diagnostics: true});
  ...
  $.fn.iframeAutoHeight = function (spec) {
    ...
    return this.each(function () {
      ...
      function resizeHeight(iframe) {
        ...
        var tmpminheight;
        tmpminheight=newHeight;
        $(iframe, window.top.document).contents().find('body div').each(function() {
            var offset = $(this).offset();
            var t = offset.top+$(this).height();
            if(t>tmpminheight)
            {
                tmpminheight = t + options.heightOffset;
            }
        });
        $(iframe, window.top.document).contents().find('body button').each(function() {
            var offset = $(this).offset();
            var t = offset.top+$(this).height();
            if(t>tmpminheight)
            {
