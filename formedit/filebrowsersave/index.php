...
<div>
    ...
    <div class="files">
        ...
        <div class="block">
            <h2>Filename</h2>
            <div>
                <input placeholder="Filename" type="text" name="filename" id="filename" value="">
            </div>
        </div>
        <div class="block">
            <h2>Files</h2>
            ...
            if($selectedDirectory!="")
            {
                ...
                foreach($files as $file)
                {
                    ...
                    $onclickFile = json_encode(preg_replace('~[\\\\/]~', DIRECTORY_SEPARATOR, $file));
                    echo "<button type=button onclick='useFile($onclickFile);'>";
...
<script type="text/javascript">
    ...
    document.getElementById("filename")
        .addEventListener("keyup", function(event) {
            ...
            if (event.keyCode == 13) {
                var path = '<?php echo getRootDir().$selectedDirectory."/"; ?>' + this.value;
                selectFile(path);
            }
        });
