...
class jsonview extends basecontrol
{
    var $name="jsonview";

    var $editorname="JSON-View";
    var $editorcategorie="Database Items";
    var $editorshow=true;
    var $editordescription='Shows a json-code from the database';
    ...
    public function getInterpreterRender()
    {
        ...
        $html='<html><body><pre>'.print_r(json_decode($value),true).'</pre></body></html>';
        ...
        if(file_exists($path) && $value!="")
            ...
            <iframe 
                ...
                width:calc('.$this->width.'px - 2px);
                height:calc('.$this->height.'px - 2px); "
